...
A fork from [vaxilu's awesome project](https://github.com/vaxilu/x-ui/) : a Multi-protocol Multi-user Xray Panel
...
````
bash <(curl -Ls https://raw.githubusercontent.com/iprodev/x-ui/master/install.sh)
````

## Manual install & upgrade

1. First update your system
1. Then download the latest compressed package from https://github.com/iprodev/x-ui/releases/latest, generally choose `amd64` architecture
